...
class KCFTracker:
    def __init__(self, hog=False, fixed_window=True, multiscale=False):
        ...
        self.padding = 2.0  # extra area surrounding the target
        self.output_sigma_factor = 0.0625  # bandwidth of gaussian target
        ...
        if (multiscale):
            ...
            self.scale_step = 1.0001  # scale step for multi-scale estimation
